...
const ProductCard = ({ product }) => {
    ...
    return (
        <div className="group bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden border border-gray-100 dark:border-gray-700 relative">
            ...
            <div className="p-5">
                ...
                <div className="flex justify-between items-end mt-4">
                    ...
                    <button
                        ...
                        className="bg-gray-900 dark:bg-primary-600 text-white p-3 rounded-xl hover:bg-primary-600 dark:hover:bg-primary-700 active:scale-95 transition-all shadow-md hover:shadow-lg flex items-center justify-center group/btn min-w-[3rem]"
                    >
