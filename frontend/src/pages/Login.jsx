...
<<<<<<< HEAD
                ...
                if (rememberMe) {
                    localStorage.setItem('shopflow_remember_me', 'true');
                    localStorage.setItem('shopflow_saved_email', values.email.trim());
                    localStorage.setItem('shopflow_saved_password', values.password);
                } else {
                    localStorage.removeItem('shopflow_remember_me');
                    localStorage.removeItem('shopflow_saved_email');
