...
const Compare = () => {
        ...
        <tr className="bg-gray-50/80">
            ...
            >
                <div className="flex items-center justify-between">
                    ...
                    {expandedSections[sectionKey] ? <FiChevronUp size={16} className="text-gray-400" /> : <FiChevronDown size={16} className="text-gray-400" />}
                </div>
            </td>
        </tr>
    );
    ...
    const EmptyCell = ({ index }) => (
        <td key={`empty-${index}`} className="px-4 py-4 border-l border-gray-100 bg-gray-50/30">
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-8">
                    <div>
                        ...
                        <p className="text-gray-500 text-sm mt-1">Comparing {compareItems.length} of 4 products</p>
                    </div>
                    <div className="flex items-center gap-3 flex-wrap">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 text-red-500 hover:text-red-700 bg-red-50 hover:bg-red-100 px-4 py-2.5 rounded-xl transition-all text-sm font-bold border-2 border-red-100 hover:border-red-200"
                        >
                        ...
                        <div className="bg-white rounded-xl border border-amber-100 p-4 shadow-sm">
                            <div className="flex items-center gap-2 mb-2">
                                <div className="w-7 h-7 rounded-lg bg-amber-100 flex items-center justify-center">
                                    <FiStar className="text-amber-600" size={14} />
                                </div>
                        ...
                        <div className="bg-white rounded-xl border border-primary-100 p-4 shadow-sm col-span-2 md:col-span-1">
                            <div className="flex items-center gap-2 mb-2">
                                <div className="w-7 h-7 rounded-lg bg-primary-100 flex items-center justify-center">
                                    <FiZap className="text-primary-600" size={14} />
                                </div>
                        ...
                        <table className="w-full text-left" id="compare-table">
                            ...
                            <thead>
                                <tr className="border-b border-gray-100">
                                    ...
                                    {compareItems.map((product) => (
                                        <th key={product._id} className="p-5 text-center min-w-[220px] max-w-[260px] border-l border-gray-100 relative group">
                                            ...
                                            <button
                                                ...
                                                className="absolute top-3 right-3 w-7 h-7 rounded-full bg-gray-100 hover:bg-red-100 text-gray-400 hover:text-red-500 flex items-center justify-center transition-all opacity-0 group-hover:opacity-100 z-10"
                                            ...
                                            <div className="flex flex-col items-center">
                                                <div className="w-28 h-28 bg-gray-50 rounded-2xl border border-gray-100 p-2 mb-3 overflow-hidden group-hover:shadow-md transition-shadow">
                                                    <img
                                                ...
                                                <Link
                                                    ...
                                                    className="text-sm font-bold text-gray-900 hover:text-primary-600 transition-colors line-clamp-2 leading-tight mb-2"
                                                >
                                                    {product.title}
                                                </Link>
                                                ...
                                                <div className="flex gap-2 mt-2">
                                                    ...
                                                    <Link
                                                        to={`/products/${product._id}`}
                                                        className="p-1.5 rounded-lg border-2 border-gray-200 bg-white text-gray-400 hover:border-primary-200 hover:text-primary-500 transition-all"
                                                    >
                                                        <FiEye size={12} />
                                                    </Link>
                                                </div>
                                    ...
                                    {Array.from({ length: Math.max(0, 4 - compareItems.length) }).map((_, index) => (
                                        <th key={`empty-header-${index}`} className="p-5 border-l border-gray-100 bg-gray-50/30">
                                            <Link
                                                to="/products"
                                            ...
                                            >
                                                <div className="w-20 h-20 border-2 border-dashed border-gray-200 group-hover/add:border-primary-300 rounded-2xl flex items-center justify-center mb-2 transition-colors">
                                                    <FiPlus size={24} />
                                                </div>
                            ...
                            <tbody>
                                ...
                                {expandedSections.pricing && (
                                    <>
                                        ...
                                        <tr className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                            <td className="px-6 py-4 font-bold text-sm text-gray-700 bg-white sticky left-0 z-10 border-r border-gray-100">
                                                Price
                                            </td>
                                            {compareItems.map((product) => (
                                ...
                                {expandedSections.details && (
                                    <>
                                        {/* Category */}
                                        <tr className={`border-b border-gray-50 hover:bg-gray-50/50 transition-colors ${highlightDifferences && isDifferent(p => p.category) ? 'bg-yellow-50/50' : ''
                                            }`}>
                                            <td className="px-6 py-4 font-bold text-sm text-gray-700 bg-white sticky left-0 z-10 border-r border-gray-100">
                                                Category
                                            </td>
                                            {compareItems.map((product) => (
                                                <td key={product._id} className="px-4 py-4 text-center border-l border-gray-100">
                                                    <span className="inline-block bg-primary-50 text-primary-700 px-3 py-1 rounded-full text-xs font-bold capitalize">
                                        ...
                                        {/* Rating */}
                                        <tr className={`border-b border-gray-50 hover:bg-gray-50/50 transition-colors ${highlightDifferences && isDifferent(p => p.rating?.rate) ? 'bg-yellow-50/50' : ''
                                            }`}>
                                            <td className="px-6 py-4 font-bold text-sm text-gray-700 bg-white sticky left-0 z-10 border-r border-gray-100">
                                                Rating
                                            </td>
                                            {compareItems.map((product) => {
                                                ...
                                                return (
                                                    <td key={product._id} className={`px-4 py-4 text-center border-l border-gray-100 ${highlightDifferences && isBest ? 'bg-amber-50' : ''
                                                        }`}>
                                                        <div className="flex flex-col items-center gap-1">
                                                            ...
                                                            <span className={`text-sm font-bold ${isBest ? 'text-amber-600' : 'text-gray-700'}`}>
                                                    ...
                                                    {product.sizes && product.sizes.length > 0 ? (
                                                        <div className="flex flex-wrap justify-center gap-1">
                                                            {product.sizes.map(size => (
                                                                <span key={size} className="bg-gray-100 text-gray-700 text-[10px] font-bold px-2 py-0.5 rounded-md">
                                                                    {size}
                                                                </span>
                                                            ))}
                                                        </div>
                                        ...
                                        <tr className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                            ...
                                            {compareItems.map((product) => (
                                                <td key={product._id} className="px-4 py-4 text-center border-l border-gray-100">
                                                    <p className="text-xs text-gray-500 leading-relaxed line-clamp-4 text-left">
                                ...
                                {specsList.length > 0 && (
                                    <>
                                        ...
                                        {expandedSections.specs && specsList.map((specKey) => (
                                            <tr key={specKey} className={`border-b border-gray-50 hover:bg-gray-50/50 transition-colors ${highlightDifferences && isDifferent(p => p.specs?.[specKey]) ? 'bg-yellow-50/50' : ''
                                                }`}>
                                                <td className="px-6 py-4 font-bold text-sm text-gray-700 bg-white sticky left-0 z-10 border-r border-gray-100 capitalize">
                                                    {specKey.replace(/([A-Z])/g, ' $1').trim()}
                                                </td>
                                                {compareItems.map((product) => (
                                                    <td key={product._id} className="px-4 py-4 text-center text-sm text-gray-600 border-l border-gray-100">
                                ...
                                <tr className="bg-gray-50/80 border-t border-gray-200">
                                    <td className="px-6 py-5 font-bold text-sm text-gray-400 uppercase tracking-wider bg-gray-50 sticky left-0 z-10 border-r border-gray-100">
                                        Actions
                                    </td>
                                    {compareItems.map((product) => (
                                        <td key={product._id} className="px-4 py-5 text-center border-l border-gray-100">
                                            <div className="flex flex-col gap-2">
                                                ...
                                                <Link
                                                    to={`/products/${product._id}`}
                                                    className="w-full flex items-center justify-center gap-1 text-primary-600 hover:text-primary-700 bg-primary-50 hover:bg-primary-100 py-2 rounded-xl text-xs font-bold transition-all"
                                                >
                ...
                <div className="mt-8 text-center">
                    <Link
                        to="/products"
                        className="inline-flex items-center gap-2 text-primary-600 hover:text-primary-700 font-bold text-sm hover:underline"
                    >
