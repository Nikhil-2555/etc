    ...
    return (
        <div className="container mx-auto px-4 py-12">
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-start">
                                        ...
                                        <tr key={`${itemId}-${item.size}`} className="group hover:bg-gray-50/50 transition-colors">
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        <h3 className="font-semibold text-gray-900 line-clamp-1 max-w-[150px] md:max-w-xs">{item.title}</h3>
                                            ...
                                            <td className="px-6 py-4 text-right font-medium text-gray-900">₹{item.price.toLocaleString('en-IN')}</td>
                ...
                {/* Order Summary */}
                <div className="w-full lg:w-96 bg-white rounded-2xl shadow-sm border border-gray-100 p-8 h-fit sticky top-24">
                    ...
                    <div className="space-y-4 mb-6 text-sm">
                        ...
                        <div className="flex justify-between text-gray-600">
                            ...
                            <span className="font-medium text-gray-900">₹{(totalPrice * 0.18).toLocaleString('en-IN')}</span>
                        </div>
                    </div>
