                                ...
                                <div className="flex items-center gap-3 flex-wrap">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <button
                                            ...
                                            className="text-indigo-500 hover:text-indigo-700 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 px-3 py-1.5 rounded-lg text-xs font-bold transition-all border border-transparent hover:border-indigo-200 dark:hover:border-indigo-800 flex items-center gap-1.5"
    ...
    return (
        <div className="container mx-auto px-4 py-12">
            ...
            <div className="flex items-center gap-4 mb-10">
                ...
                <h1 className="text-3xl font-bold text-gray-900 dark:text-white tracking-tight">My Account</h1>
            </div>

            <div className="flex flex-col lg:flex-row gap-10">
                {/* Sidebar */}
                <div className="w-full lg:w-80 space-y-4">
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm mb-6 relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-24 h-24 bg-primary-50 dark:bg-primary-900/20 rounded-full -translate-y-12 translate-x-12"></div>
                        <div className="relative z-10 text-center">
                            <div className="w-20 h-20 bg-primary-600 rounded-full flex items-center justify-center text-white text-3xl font-bold mx-auto mb-6">
                            ...
                            <div className="inline-block px-3 py-1 bg-gray-900 dark:bg-gray-700 text-white text-[10px] font-semibold rounded-full uppercase tracking-widest">
                                {user?.role} Account
                            </div>
                        </div>
                    </div>

                    <div className="bg-white dark:bg-gray-800 p-3 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm space-y-1">
                        <button
                            onClick={() => setActiveTab('orders')}
                            className={`flex items-center gap-3 w-full px-5 py-3 rounded-xl font-semibold transition-colors ${activeTab === 'orders' ? 'bg-primary-600 text-white' : 'text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700'}`}
                        >
                            <FiBox size={20} /> Orders
                        </button>
                        <button
                            onClick={() => setActiveTab('profile')}
                            className={`flex items-center gap-3 w-full px-5 py-3 rounded-xl font-semibold transition-colors ${activeTab === 'profile' ? 'bg-primary-600 text-white' : 'text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700'}`}
                        >
                            <FiUser size={20} /> Profile Details
                        </button>
                        <button
                            onClick={() => setActiveTab('settings')}
                            className={`flex items-center gap-3 w-full px-5 py-3 rounded-xl font-semibold transition-colors ${activeTab === 'settings' ? 'bg-primary-600 text-white' : 'text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700'}`}
                        >
                            <FiSettings size={20} /> Settings
                        </button>
                        <hr className="my-2 border-gray-50 dark:border-gray-700" />
                        <button onClick={logout} className="flex items-center gap-3 w-full px-5 py-3 text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-xl font-semibold transition-colors">
                    ...
                    <div className="bg-gray-900 p-5 rounded-2xl text-white relative overflow-hidden">
                        <div className="relative z-10">
                            ...
                            <p className="text-lg font-bold">{new Date().toLocaleDateString('en-IN', { weekday: 'long' })}</p>
                ...
                {/* Content Area */}
                <div className="flex-1 bg-white dark:bg-gray-800 p-8 md:p-10 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm min-h-[600px]">
